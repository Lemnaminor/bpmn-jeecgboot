  ...
  <div class="panel-tab__content">
    ...
    >
      <template
        ...
        slot-scope="text"
      >
        <j-ellipsis :value="listenerEventTypeObject[text]" :length="3"></j-ellipsis>
      </template>
      <template
        slot="listenerType"
        slot-scope="text"
...
import { initListenerType, listenerType, eventType } from "../utilSelf";
...
export default {
  ...
  data() {
    return {
      ...
      dataSourceListener: [
        {
          id: "02bcfbe354756f4d272ecb43972c169e",
          listenereven: "create",
          listenername: "子流程",
          listenertype: "expression",
          listenervalue: "${subProcessListener}",
          state: "closed",
        },
        {
          id: "1278256955102859265",
          listenereven: "complete",
          listenername: "公文发文分发",
          listenertype: "class",
          listenervalue:
    ...
    saveListenerConfig() {
      ...
      if (tabKeys == "1") {
        ...
        this.selectedRows.forEach((item) => {
          ...
          // 更新bpmn标签
          const listenerObject = createListenerObject(obj, true, this.prefix);
