      ...
      <template v-if="!$slots['control-header']">
        <a-button-group>
          <a-tooltip placement="bottom">
            ...
            <a-button @click="$refs.refFile.click()">
              <a-icon type="import" />
            </a-button>
          </a-tooltip>
          <a-tooltip placement="bottom">
            <template slot="title">
              <div class="downbtn"><a @click="downloadProcessAsBpmn()"><span>下载为BPMN文件</span></a></div>
              <div class="downbtn"><a @click="downloadProcessAsXml()"><span>下载为XML文件</span></a></div>
              <div class="downbtn"><a @click="downloadProcessAsSvg()"><span>下载为SVG文件</span></a></div>
            </template>
            <a-button>
          ...
          <a-tooltip placement="bottom">
            <template slot="title">
              <div class="downbtn"><a @click="previewProcessXML"><span>预览XML</span></a></div>
              <div class="downbtn"><a @click="previewProcessJson"><span>预览JSON</span></a></div>
            </template>
            <a-button>
              <a-icon type="eye" />
            </a-button>
          ...
          <a-tooltip placement="bottom">
            <template slot="title">
              <span>{{this.simulationStatus ? '退出模拟' : '开启模拟'}}</span>
            </template>
            <a-button @click="processSimulation">
              <a-icon :type="this.simulationStatus ? 'pause' : 'play-circle'" />
            </a-button>
          </a-tooltip>
          <a-tooltip placement="bottom">
            <template slot="title">
        ...
        <a-button-group style="margin-left: 10px;">
          <a-tooltip placement="bottom">
            ...
            <a-button @click="elementsAlign('left')">
          ...
          <a-tooltip placement="bottom">
            ...
            <a-button @click="elementsAlign('right')">
          ...
          <a-tooltip placement="bottom">
            ...
            <a-button @click="elementsAlign('center')">
          ...
          <a-tooltip placement="bottom">
            ...
            <a-button @click="elementsAlign('bottom')">
          ...
          <a-tooltip placement="bottom">
            ...
            <a-button @click="elementsAlign('top')">
          ...
          <a-tooltip placement="bottom">
            ...
            <a-button @click="elementsAlign('middle')">
        ...
        <a-button-group style="margin-left: 10px;">
          <a-tooltip placement="bottom">
            ...
            <a-button @click="processZoomIn()">
              <a-icon type="zoom-in" />
            </a-button>
          </a-tooltip>
          <a-button>{{ Math.floor(this.defaultZoom * 10 * 10) + "%" }}</a-button>
          <a-tooltip placement="bottom">
            <template slot="title">
              <span>缩小视图</span>
            </template>
            <a-button @click="processZoomOut()">
  ...
  methods: {
    ...
    elementsAlign(align) {
      ...
      if (!SelectedElements || SelectedElements.length <= 1) {
        ...
        this.$message.warning("请按住 Shift 键框选多个元素对齐");
        return;
      }
